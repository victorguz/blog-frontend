...
export const environment = {
  ...
  apis: {
    pockets: {
      ...
      id: { value: "pockets/{{:id}}", method: "GET", contentType: "application/json" },
      create: { value: "pockets", method: "POST", contentType: "application/json" },
      update: { value: "pockets/{{:id}}", method: "PATCH", contentType: "application/json" },
      delete: { value: "pockets/{{:id}}", method: "DELETE", contentType: "application/json" },
    },
    categories: {
      all: { value: "categories", method: "GET", contentType: "application/json" },
      id: { value: "categories/{{:id}}", method: "GET", contentType: "application/json" },
      create: { value: "categories", method: "POST", contentType: "application/json" },
      update: { value: "categories/{{:id}}", method: "PATCH", contentType: "application/json" },
      delete: { value: "categories/{{:id}}", method: "DELETE", contentType: "application/json" },
    },
    movements: {
      all: { value: "movements", method: "GET", contentType: "application/json" },
      id: { value: "movements/{{:id}}", method: "GET", contentType: "application/json" },
      create: { value: "movements", method: "POST", contentType: "application/json" },
      update: { value: "movements/{{:id}}", method: "PATCH", contentType: "application/json" },
      delete: { value: "movements/{{:id}}", method: "DELETE", contentType: "application/json" },
    },
  },
  /**
  ...
  allowedDomains: [
    "http://localhost:3000/",
    "https://oagy7ri2z8.execute-api.us-west-2.amazonaws.com/dev/",
    "https://h2s8ydmmt5.execute-api.us-west-2.amazonaws.com/qas/",
    "https://oagy7ri2z8.execute-api.us-west-2.amazonaws.com/dev/",
  ],
  /**
